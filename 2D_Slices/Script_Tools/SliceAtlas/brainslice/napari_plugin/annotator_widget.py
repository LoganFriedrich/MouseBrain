...
from brainslice.napari_plugin.annotator_worker import ND2LoaderWorker
from brainslice.core.channel_model import ChannelSettings, create_default_channel_settings, DEFAULT_CHANNEL_COLORS
from brainslice.core.image_utils import auto_contrast, COLORMAPS
...
class SliceAnnotatorWidget(QWidget):
    ...
    def _load_folder(self, folder_path: Path):
        ...
        """
        from brainslice.napari_plugin.annotator_worker import FolderLoaderWorker
    ...
    def _export_composite_view(self, output_path: Path, scope: str):
        ...
        """
        from brainslice.core.io import save_tiff
        from brainslice.core.image_utils import composite_channels
