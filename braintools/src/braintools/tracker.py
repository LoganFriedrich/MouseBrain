#!/usr/bin/env python3
"""
tracker.py (braintools package)

Calibration run tracking system for the BrainGlobe pipeline.

This module is now part of the braintools package and tracks CALIBRATION runs
...
Usage as CLI:
    python -m braintools.tracker                    # Show recent runs
    python -m braintools.tracker --search "349"     # Search by brain
    python -m braintools.tracker --stats            # Show statistics
"""
...
from braintools.config import CALIBRATION_RUNS_CSV as DEFAULT_TRACKER_PATH, parse_brain_name
...
Examples:
    python -m braintools.tracker                    # Show recent runs
    python -m braintools.tracker --search "349"     # Search by brain
    python -m braintools.tracker --type detection   # Filter by type
    python -m braintools.tracker --stats            # Show statistics
    python -m braintools.tracker --best detection   # Best detection runs
        """
    )
