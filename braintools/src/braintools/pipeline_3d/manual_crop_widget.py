...
from braintools.config import BRAINS_ROOT as DEFAULT_BRAINGLOBE_ROOT
...
class ManualCropWidget(QWidget):
    ...
    def _populate_brain_list(self):
        ...
        y_drive_path = Path(r"Y:\LAB_ROOT\Tissue\3D_Cleared\1_Brains")
    ...
    def _browse_for_brain(self):
        ...
        browse_start = Path(r"Y:\LAB_ROOT\Tissue\3D_Cleared\1_Brains")
