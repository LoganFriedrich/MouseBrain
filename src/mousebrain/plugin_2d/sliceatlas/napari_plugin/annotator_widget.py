...
from mousebrain.plugin_2d.sliceatlas.napari_plugin.annotator_worker import ND2LoaderWorker
from mousebrain.plugin_2d.sliceatlas.core.channel_model import ChannelSettings, create_default_channel_settings, DEFAULT_CHANNEL_COLORS
from mousebrain.plugin_2d.sliceatlas.core.image_utils import auto_contrast, COLORMAPS
...
class SliceAnnotatorWidget(QWidget):
    ...
    def _load_folder(self, folder_path: Path):
        ...
        """
        from mousebrain.plugin_2d.sliceatlas.napari_plugin.annotator_worker import FolderLoaderWorker
    ...
    def _export_composite_view(self, output_path: Path, scope: str):
        ...
        """
        from mousebrain.plugin_2d.sliceatlas.core.io import save_tiff
        from mousebrain.plugin_2d.sliceatlas.core.image_utils import composite_channels
