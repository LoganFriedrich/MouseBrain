...
Usage:
    from mousebrain.pipeline_2d.sliceatlas.core import load_image, NucleiDetector, ColocalizationAnalyzer
    from mousebrain.pipeline_2d.sliceatlas.tracker import SliceTracker
"""
