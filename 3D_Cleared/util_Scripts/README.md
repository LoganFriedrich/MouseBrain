...
```
Y:\2_Connectome\3_Nuclei_Detection\util_Scripts\
```

The experiment tracker creates its CSV at:
```
Y:\2_Connectome\3_Nuclei_Detection\2_Summary_Data\experiments.csv
```
...
# 1. Launch napari
# 2. Plugins → SCI-Connectome Pipeline → Manual Crop
```
