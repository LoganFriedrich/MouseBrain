...
This tracks CALIBRATION runs (tuning/optimization) - detection parameter tests,
model training, classification tests, etc. These are iterative experiments to
...
Usage as CLI:
    ...
    python experiment_tracker.py --stats            # Show statistics
"""
...
from config import CALIBRATION_RUNS_CSV as DEFAULT_TRACKER_PATH, parse_brain_name
...
Examples:
    python experiment_tracker.py                    # Show recent runs
    python experiment_tracker.py --search "349"     # Search by brain
    python experiment_tracker.py --type detection   # Filter by type
    python experiment_tracker.py --stats            # Show statistics
