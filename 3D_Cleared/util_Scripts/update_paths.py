...
BRAINS_ROOT = Path(r"Y:/LAB_ROOT/3_Nuclei_Detection/1_Brains")
SCRIPTS_DIR = Path(r"Y:/LAB_ROOT/3_Nuclei_Detection/util_Scripts")""",
...
DEFAULT_BRAINGLOBE_ROOT = Path(r"Y:\\LAB_ROOT\\3_Nuclei_Detection\\1_Brains")""",
        "new": """# =============================================================================
# CONFIGURATION
# =============================================================================
...
tuning_models_update = {
    "sci_connectome_napari/sci_connectome_napari/tuning_widget.py": {
        "old": 'models_dir = Path(r"Y:\\LAB_ROOT\\3_Nuclei_Detection\\util_Brainglobe\\Trained_Models")',
